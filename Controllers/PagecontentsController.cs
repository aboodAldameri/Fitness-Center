...
namespace Fitness_Center.Controllers
{
    public class PagecontentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Sectionname,Title,Subtitle,Description,Imageurl")] Pagecontent pagecontent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Sectionname,Title,Subtitle,Description,Imageurl")] Pagecontent pagecontent)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!PagecontentExists(pagecontent.Id))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
          return (_context.Pagecontents?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
